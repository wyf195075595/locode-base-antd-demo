...
import MutiplePpagePlugin from './plugins/plugin-mutiple-page'
import './global.scss';
...
async function registerPlugins() {
  ...
  // 获取页面路径
  const scenarioName: string = new URLSearchParams(window.location.search).get("page") || "home";
  ...
  // 多页面 plugin
  await plugins.register(MutiplePpagePlugin);
};
