 ...
 * @LastEditTime: 2023-06-21 09:44:13
 * @LastEditors:  
 */
...
const getScenarioName = function () {
  if (location.search) {
    return new URLSearchParams(location.search.slice(1)).get('scenarioName') || 'home';
  }
  return 'home';
}
...
const SamplePreview = () => {
  ...
  async function init() {
    ...
    console.log("scenarioName: ",scenarioName, packages, projectSchema);
